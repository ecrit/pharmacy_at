...
/**
 * This is the item provider adapter for a {@link at.medevit.ecrit.pharmacy_at.model.Report} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addIssuerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Report_issuer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Report_issuer_feature", "_UI_Report_type"),
